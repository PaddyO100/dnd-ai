...
export const Campaign = z.object({
  ...
  worldInfo: z.object({
    ...
    theme: z.enum(['adventure', 'mystery', 'political', 'survival', 'exploration']),
    techLevel: z.literal('medieval'),
    magicLevel: z.enum(['none', 'rare', 'common', 'abundant']),
    climateSetting: z.enum(['temperate', 'tropical', 'arctic', 'desert', 'varied']),
  }),
