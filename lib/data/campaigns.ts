...
export const OFFICIAL_CAMPAIGNS: Campaign[] = [
  {
    ...
    worldInfo: {
      description: 'A classic heroic fantasy adventure with dragons, magic, and brave heroes.',
      goals: ['Defeat the ancient dragon', 'Save the villages', 'Discover magical artifacts'],
      tone: 'light',
      theme: 'adventure',
      techLevel: 'medieval',
      magicLevel: 'common',
      climateSetting: 'temperate',
    },
  ...
  },
  {
    ...
    worldInfo: {
      description: 'A dark mystery unfolding in the streets of a great city.',
      goals: ['Solve the murder case', 'Uncover the conspiracy', 'Navigate urban politics'],
      tone: 'dark',
      theme: 'mystery',
      techLevel: 'medieval',
      magicLevel: 'common',
  ...
  },
  {
    ...
    worldInfo: {
      description: 'A survival adventure in dangerous wilderness exploring ancient ruins.',
      goals: ['Explore the lost ruins', 'Survive the wilderness', 'Discover ancient secrets'],
      tone: 'balanced',
      theme: 'survival',
      techLevel: 'medieval',
      magicLevel: 'rare',
      climateSetting: 'varied',
    },
    createdAt: '2024-01-01T00:00:00Z',
    updatedAt: '2024-01-01T00:00:00Z',
  },
  {
    ...
    worldInfo: {
      description: 'An epic planar adventure across multiple dimensions and realities.',
      goals: ['Traverse multiple planes', 'Prevent planar collapse', 'Master planar magic'],
      tone: 'balanced',
      theme: 'exploration',
      techLevel: 'medieval',
      magicLevel: 'abundant',
